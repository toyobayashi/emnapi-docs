...
你也可以使用官方的 C++ wrapper [node-addon-api](https://github.com/nodejs/node-addon-api)，它（[v5.1.0](https://github.com/nodejs/node-addon-api/releases/tag/v5.1.0)）已被集成在这个包里，但不可使用 Node.js 环境特定的 API，如 `CallbackScope`。
