const tr = {
  '/': {
    ...
    usingCppWrapper: 'Using C++ and node-addon-api',
    usingCMake: 'Using CMake',
    usingNodeGyp: 'Using node-gyp (Experimental)',
    usingRust: 'Using Rust',
  ...
  '/zh/': {
    ...
    gettingStarted: '开始使用',
    usingCppWrapper: '使用 C++ 和 node-addon-api',
    usingCMake: '使用 CMake',
    usingNodeGyp: '使用 node-gyp（实验性）',
    usingRust: '使用 Rust',
    errorHandling: '错误处理',
