...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#676E95;font-style:italic;"># target_link_libraries(hello emmalloc)</span></span>
<span class="line"><span style="color:#89DDFF;">endif</span><span style="color:#A6ACCD;">()</span></span>
<span class="line"></span></code></pre></div><p>用 <code>emcmake</code> 构建，输出 <code>build/hello.js</code> 和 <code>build/hello.wasm</code>。</p><p>可以使用 <code>-DEMNAPI_FIND_NODE_ADDON_API=ON</code> 或通过 <code>include_directories()</code> 或 <code>target_include_directories()</code> 手动将 node-addon-api 目录添加到包含目录。</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">mkdir</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">build</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># emscripten</span></span>
<span class="line"><span style="color:#FFCB6B;">emcmake</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">cmake</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-DCMAKE_BUILD_TYPE=Release</span><span style="color:#A6ACCD;"> \\</span></span>
<span class="line"><span style="color:#A6ACCD;">              </span><span style="color:#C3E88D;">-DEMNAPI_FIND_NODE_ADDON_API=ON</span><span style="color:#A6ACCD;"> \\</span></span>
...
<span class="line"></span></code></pre></div>`,7),e=[o];function t(c,r,C,A,D,i){return a(),n("div",null,e)}const E=s(p,[["render",t]]);export{_ as __pageData,E as default};
