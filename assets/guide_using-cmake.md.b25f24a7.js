...
<span class="line"></span></code></pre></div><p>Building with <code>emcmake</code>, output <code>build/hello.js</code> and <code>build/hello.wasm</code>.</p><p>If you use node-addon-api, you can use <code>-DEMNAPI_FIND_NODE_ADDON_API=ON</code> or manually add node-addon-api directory to the include dir via <code>include_directories()</code> or <code>target_include_directories()</code>.</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">mkdir</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">build</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div>`,7),e=[o];function t(c,r,C,A,i,D){return n(),a("div",null,e)}const d=s(p,[["render",t]]);export{_ as __pageData,d as default};
