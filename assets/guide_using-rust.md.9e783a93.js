import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.957b8f8c.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/using-rust.md","filePath":"guide/using-rust.md","lastUpdated":1699607660000}'),p={name:"guide/using-rust.md"},o=l(`<p>Currently you can use <a href="https://github.com/napi-rs/napi-rs" target="_blank" rel="noreferrer">napi-rs</a> like this, more work is working in progress.</p><p>Note: WASI target require rust nightly toolchain.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-EO6nG" id="tab-i71N1_e" checked="checked"><label for="tab-i71N1_e">Cargo.toml</label><input type="radio" name="group-EO6nG" id="tab-NFvuzgt"><label for="tab-NFvuzgt">.cargo/config.toml</label><input type="radio" name="group-EO6nG" id="tab-EUhQ8oy"><label for="tab-EUhQ8oy">src/main.rs</label><input type="radio" name="group-EO6nG" id="tab-i-CwQ1a"><label for="tab-i-CwQ1a">index.js</label></div><div class="blocks"><div class="language-toml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">package</span><span style="color:#E1E4E8;">]</span></span>
