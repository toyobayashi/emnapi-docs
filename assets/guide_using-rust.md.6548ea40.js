import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.c6d1d410.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/using-rust.md","filePath":"guide/using-rust.md","lastUpdated":1698229211000}'),p={name:"guide/using-rust.md"},o=l(`<p>Currently you can use <a href="https://github.com/napi-rs/napi-rs" target="_blank" rel="noreferrer">napi-rs</a> like this, more work is working in progress.</p><p>Note: WASI target require rust nightly toolchain.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Z9cDg" id="tab-BQ13mBg" checked="checked"><label for="tab-BQ13mBg">Cargo.toml</label><input type="radio" name="group-Z9cDg" id="tab-XXRefXv"><label for="tab-XXRefXv">.cargo/config.toml</label><input type="radio" name="group-Z9cDg" id="tab-b2y_DNX"><label for="tab-b2y_DNX">src/main.rs</label><input type="radio" name="group-Z9cDg" id="tab-GzJAzpu"><label for="tab-GzJAzpu">index.js</label></div><div class="blocks"><div class="language-toml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">package</span><span style="color:#E1E4E8;">]</span></span>
...
<span class="line"><span style="color:#24292E;">})</span></span></code></pre></div></div></div>`,3),e=[o];function t(c,r,E,y,i,u){return n(),a("div",null,e)}const C=s(p,[["render",t]]);export{q as __pageData,C as default};
