...
<span class="line"><span style="color:#D73A49;">endif</span><span style="color:#24292E;">()</span></span></code></pre></div><p>用 <code>emcmake</code> 构建，输出 <code>build/hello.js</code> 和 <code>build/hello.wasm</code>。</p><p>可以使用 <code>-DEMNAPI_FIND_NODE_ADDON_API=ON</code> 或通过 <code>include_directories()</code> 或 <code>target_include_directories()</code> 手动将 node-addon-api 目录添加到包含目录。</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">mkdir</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">build</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">      </span><span style="color:#005CC5;">-G</span><span style="color:#24292E;"> </span><span style="color:#032F62;">Ninja</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-H.</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-Bbuild</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;">cmake</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--build</span><span style="color:#24292E;"> </span><span style="color:#032F62;">build</span></span></code></pre></div>`,7),e=[o];function t(c,r,E,y,i,_){return n(),a("div",null,e)}const C=s(p,[["render",t]]);export{d as __pageData,C as default};
