import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.c6d1d410.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/using-rust.md","filePath":"guide/using-rust.md","lastUpdated":1698230210000}'),p={name:"guide/using-rust.md"},o=l(`<p>Currently you can use <a href="https://github.com/napi-rs/napi-rs" target="_blank" rel="noreferrer">napi-rs</a> like this, more work is working in progress.</p><p>Note: WASI target require rust nightly toolchain.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-L2VEp" id="tab-6jyuzK_" checked="checked"><label for="tab-6jyuzK_">Cargo.toml</label><input type="radio" name="group-L2VEp" id="tab-X-yz7QQ"><label for="tab-X-yz7QQ">.cargo/config.toml</label><input type="radio" name="group-L2VEp" id="tab-RASoJO8"><label for="tab-RASoJO8">src/main.rs</label><input type="radio" name="group-L2VEp" id="tab-2SXw9sU"><label for="tab-2SXw9sU">index.js</label></div><div class="blocks"><div class="language-toml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">package</span><span style="color:#E1E4E8;">]</span></span>
