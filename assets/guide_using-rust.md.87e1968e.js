import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.957b8f8c.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/using-rust.md","filePath":"guide/using-rust.md","lastUpdated":1699777824000}'),p={name:"guide/using-rust.md"},o=l(`<p>Currently you can use <a href="https://github.com/napi-rs/napi-rs" target="_blank" rel="noreferrer">napi-rs</a> like this, more work is working in progress.</p><p>Note: WASI target require rust nightly toolchain.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-yKAa4" id="tab-aqo0NhA" checked="checked"><label for="tab-aqo0NhA">Cargo.toml</label><input type="radio" name="group-yKAa4" id="tab-_-gf1YQ"><label for="tab-_-gf1YQ">.cargo/config.toml</label><input type="radio" name="group-yKAa4" id="tab-7VRxfsx"><label for="tab-7VRxfsx">src/main.rs</label><input type="radio" name="group-yKAa4" id="tab-ux_75vB"><label for="tab-ux_75vB">index.js</label></div><div class="blocks"><div class="language-toml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">package</span><span style="color:#E1E4E8;">]</span></span>
