import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.957b8f8c.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/guide/using-rust.md","filePath":"zh/guide/using-rust.md","lastUpdated":1699777824000}'),p={name:"zh/guide/using-rust.md"},o=l(`<p>目前你可以像这样使用 <a href="https://github.com/napi-rs/napi-rs" target="_blank" rel="noreferrer">napi-rs</a>，更多支持工作正在进行中。</p><p>注意：WASI 构建目标需要使用 rust nightly toolchain。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-a1Bhm" id="tab-cPcnSKR" checked="checked"><label for="tab-cPcnSKR">Cargo.toml</label><input type="radio" name="group-a1Bhm" id="tab-9dWlJfy"><label for="tab-9dWlJfy">.cargo/config.toml</label><input type="radio" name="group-a1Bhm" id="tab-bycIDLR"><label for="tab-bycIDLR">src/main.rs</label><input type="radio" name="group-a1Bhm" id="tab-CaMMa3A"><label for="tab-CaMMa3A">index.js</label></div><div class="blocks"><div class="language-toml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">package</span><span style="color:#E1E4E8;">]</span></span>
