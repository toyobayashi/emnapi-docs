import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.957b8f8c.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/guide/using-rust.md","filePath":"zh/guide/using-rust.md","lastUpdated":1699607660000}'),p={name:"zh/guide/using-rust.md"},o=l(`<p>目前你可以像这样使用 <a href="https://github.com/napi-rs/napi-rs" target="_blank" rel="noreferrer">napi-rs</a>，更多支持工作正在进行中。</p><p>注意：WASI 构建目标需要使用 rust nightly toolchain。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-U7duj" id="tab-09e6GMb" checked="checked"><label for="tab-09e6GMb">Cargo.toml</label><input type="radio" name="group-U7duj" id="tab-k0-kmiP"><label for="tab-k0-kmiP">.cargo/config.toml</label><input type="radio" name="group-U7duj" id="tab-3IsYCMu"><label for="tab-3IsYCMu">src/main.rs</label><input type="radio" name="group-U7duj" id="tab-rop2faP"><label for="tab-rop2faP">index.js</label></div><div class="blocks"><div class="language-toml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">package</span><span style="color:#E1E4E8;">]</span></span>
